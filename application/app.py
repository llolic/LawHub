...
class FetchQuiz(Resource):
    def post(self):
        ...
        questionsQuery = f'SELECT questionType, option1, option2, option3, option4, correctAnswer, questionId FROM Question RIGHT JOIN QuizContains ON Question.questionId=QuizContains.questionId WHERE quizId={quizId};'
